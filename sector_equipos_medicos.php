...
$sql_total = "SELECT COUNT(*) as total FROM componentes WHERE especialidad IN ('electrodo','vac')";
...
$sql_final = "SELECT * FROM componentes WHERE especialidad IN ('electrodo','vac') ORDER BY fecha_ingreso DESC LIMIT $cantidad_por_pagina OFFSET $offset";
