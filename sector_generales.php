...
$sql_total = "SELECT COUNT(*) as total FROM componentes WHERE especialidad IN ('insumo clinico','suero','drenaje')";
...
$sql_final = "SELECT * FROM componentes WHERE especialidad IN ('insumo clinico','suero','drenaje') ORDER BY fecha_ingreso DESC LIMIT $cantidad_por_pagina OFFSET $offset";
