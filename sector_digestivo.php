...
$sql_total = "SELECT COUNT(*) as total FROM componentes WHERE especialidad = 'digestivo'";
...
$sql_final = "SELECT * FROM componentes WHERE especialidad = 'digestivo' ORDER BY fecha_ingreso DESC LIMIT $cantidad_por_pagina OFFSET $offset";
