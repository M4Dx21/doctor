...
$sql_total = "SELECT COUNT(*) as total FROM componentes WHERE especialidad = 'coloprocto'";
...
$sql_final = "SELECT * FROM componentes WHERE especialidad = 'coloprocto' ORDER BY fecha_ingreso DESC LIMIT $cantidad_por_pagina OFFSET $offset";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Administración de Insumos de Coloprocto</title>
