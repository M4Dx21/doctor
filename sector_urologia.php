...
$sql_total = "SELECT COUNT(*) as total FROM componentes WHERE especialidad IN ('urologia', 'cateter', 'dialisis')";
...
$sql_final = "SELECT * FROM componentes WHERE especialidad IN ('urologia', 'cateter', 'dialisis') ORDER BY fecha_ingreso DESC LIMIT $cantidad_por_pagina OFFSET $offset";
...
<head>
    ...
    <script src="ruta/correcta/carrito.js"></script>
</head>
<body>
    <div class="container">
